...
import com.k8s.k8sclient.k8s.crd.DummySpec;
...
public class CRDTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CRDTest.class);
    ...
    public static void main(String[] args) {
        ...
        String master = "http://121.36.70.254:8080/";
        if (args.length > 0) {
